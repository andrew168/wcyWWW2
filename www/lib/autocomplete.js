            ...
            return {
                ...
                link: function ($scope, element, attrs, controller) {
                    ...
                    function initAutocompleteDrawer() {
                        ...
                        var drawerElement = angular.element('<div id="TobeHiddenWhenStateChange" g-places-autocomplete-drawer ></div>'),
                    ...
                    var ToHideDiv = document.getElementById("TobeHiddenWhenStateChange");


                    var box = document.getElementById("HideGoogleAutoCompleteWhenStateChange");

                    box.addEventListener( 'transitionend', function( event ) {ToHideFunction();}, false );

                    function ToHideFunction(){ ToHideDiv.remove()}
    ...
    .directive('gPlacesAutocompleteDrawer', ['$window', '$document', function ($window, $document) {
        ...
        return {
            ...
            link: function ($scope, element) {
                ...
                $scope.hidePredictions = {}
                        $scope.hidePredictions.v = true;
