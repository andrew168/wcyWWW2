...
ob_start();
session_start();
require_once(dirname(dirname(dirname(__FILE__))).'/tq/config.inc.php');
/**
 * PHP 部分专用的配置文件
 */
...
define('DATABASE_NAME', TQ_WCY_DBNAME);
define('DATABASE_USER', TQ_DBUSER);
define('DATABASE_PSW', TQ_DBPW);
define('DATABASE_HOST', TQ_DBHOST);
define('DOMAIN_NAME', MC_BASE_URL);
define('NOT_FOUND', -1);
