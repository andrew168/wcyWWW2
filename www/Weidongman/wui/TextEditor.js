...
(function () {
    ...
    TextEditor.x0 = 100;
    TextEditor.fontcolor=null;
    TextEditor.fontsize=TQ.Config.fontSize;
    ...
    TextEditor.realTimeUpdate = function () {
        ...
        if (TextEditor.lastElement != null)
        {
            ...
            var fontColor=TextEditor.fontcolor;
    ...
    TextEditor.setFontColor=function(color){
        TQ.TextEditor.fontcolor=color;
        TQ.TextEditor.realTimeUpdate();
    }

    TextEditor.create=function(){
        $("#textEditBoxDivFontSize .jdt-progress").slider({
            range: "min",
            value: TQ.Config.fontSize,
            min: 5,
            max: 72,
            create: function( event, ui ) {
                $('#textEditBoxDivFontSize .jdt-progress .ui-slider-handle').attr('class','jdt-slider-handle')
            },
            slide: function(event, ui) {
                var pd=ui.value;
                TQ.TextEditor.fontsize=pd;
                TQ.TextEditor.realTimeUpdate();
